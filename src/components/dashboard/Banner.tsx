...
export function Banner({ className }: HeroBannerProps) {
  return (
    <motion.div
      ...
      className={cn(
        "w-full md:flex-1 lg:min-w-[500px] relative h-full bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-900 dark:to-blue-900 rounded-2xl p-4 sm:p-6 md:p-8 text-white overflow-hidden border border-purple-200 dark:border-gray-800 shadow",
        className
      )}
    >
      <div className="relative z-10 flex flex-col items-start">
        ...
        <div className="w-full flex justify-start">
          <motion.div whileHover={{ scale: 1.05, boxShadow: '0 4px 20px rgba(0,0,0,0.15)' }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
            <Button className="w-full sm:w-auto bg-black hover:bg-gray-800 dark:bg-gray-100 dark:hover:bg-gray-300 text-white dark:text-gray-900 rounded-full px-4 sm:px-6 py-2 text-sm sm:text-base transition-transform">
              Book Service
